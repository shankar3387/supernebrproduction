...
export class CreateBlogs extends Component {
    render() {
        return (
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12 mb-5">
                  <h2>Blog <i className="fa fa-angle-right font-weight-bold" aria-hidden="true" /> Create Blog</h2>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-lg-6 offset-lg-1">
                  <h6 className="border_right"><span>My Previous Blogs</span></h6>
                      ...
                      <div className="card mt-2">
                        ...
                        <div className="card-body p-2">
                          <div className>
                            ...
                            <p className="m-0"><b>Food for better health</b></p>
                            <span><small>Lorem Ipsum is simply dummy text of dummy</small></span>
                          </div>
                          <div className="media m-0">
                            ...
                            <div className="media-body">
                              <small><span className="m-0 on_name"><b>Benjamin Robinson</b></span></small><br />
