                  ...
                  <div className="card card-signin my-5">
                    <div className="card-body">
                      ...
                      <form onSubmit={this.onSubmit} className="form-signin">
                        ...
                        <div className="form-group">
                          <input onChange={this.handleChange} name='email' type="text" id className="form-control" placeholder="Email"  />
                        </div>
                        ...
                        <button  className="btn btn-lg btn-warning text-white btn-block text-uppercase" type="submit">Login</button>
                        
                        <div className="mt-4">
                          <div className="float-right pr-2">
                            <a href><i className="fa fa-arrow-circle-right" aria-hidden="true" style={{fontSize: 30, color: '#ffa500'}} /></a>
                          </div>
