...
import $ from 'jquery';
export class CartProcess extends Component {
      ...
      <div className="center">
        <ul className="no-bullets cart_list d-flex justify-content-between">
          <li className="cart_sublist cart_sublist_first cart_payment">
            <span className><img src="images/cart.png" className="img-fluid" /></span>
            <span className="hide_btn"><i className="cart_circle fa fa-circle-thin" aria-hidden="true" /></span>
            <span className="cart_active_span"><i className="fa fa-circle cart_active" aria-hidden="true" /></span>
            <span className="cart_confirm_span hide_btn"><i className="fa fa-check-circle cart_confirm" aria-hidden="true" /></span>
            <span><small>Cart</small></span>
          </li>
          <li className="cart_sublist cart_sublist_second">
            <span><img src="images/map.png" className="img-fluid" /></span>
            <span className="map_span"><i className="cart_circle fa fa-circle-thin" aria-hidden="true" /></span>
            <span className="map_active_span hide_btn"><i className="fa fa-circle cart_active" aria-hidden="true" /></span>
            <span className="map_confirm_span hide_btn"><i className="fa fa-check-circle cart_confirm" aria-hidden="true" /></span>
            <span><small>Address</small></span>
          </li>
          <li className="cart_sublist cart_sublist_third">
            <span><img src="images/card.png" className="img-fluid" /></span>
            <span className="payment_span"><i className="cart_circle fa fa-circle-thin" aria-hidden="true" /></span>
            <span className="payment_active_span hide_btn"><i className="fa fa-circle cart_active" aria-hidden="true" /></span>
            <span className="payment_confirm_span hide_btn"><i className="fa fa-check-circle cart_confirm" aria-hidden="true" /></span>
            <span><small>Payment</small></span>
          </li>
          <li className="cart_sublist cart_sublist_fourth">
            <span><img src="images/confirm.png" className="img-fluid" /></span>
            <span className="confirmed_span"><i className="cart_circle fa fa-circle-thin" aria-hidden="true" /></span>
            <span className="confirmed_active_span hide_btn"><i className="fa fa-circle cart_active" aria-hidden="true" /></span>
            <span className="confirmed_confirm_span hide_btn"><i className="fa fa-check-circle cart_confirm" aria-hidden="true" /></span>
            <span><small>Confirmed</small></span>
          </li>
        </ul>
      </div>	
    </div>
        ...
        <div className="col-lg-9">
          <div className="row border_bottom pt-4">
            ...
            <div className="col-lg-6">
              <h6>Casual Shirt</h6>
              <h5><span className="primary_color"><small><i className="fa fa-inr" /> <del>379</del></small></span> <i className="fa fa-inr" />341</h5>
              <table className="table table-borderless cart_price">
                <tbody>
                  <tr>
                    <td><small>Units Available</small></td>
                    <td><small>15</small></td>
                  </tr>
                  <tr>
                    <td><small>Order Units</small></td>
                    <td>
                      <span>
            ...
            <div className="col-lg-4">
              <ul className="no-bullets d-flex justify-content-end">
                <li className="pl-3 share"><i className="fa fa-share-alt" aria-hidden="true" /></li>
                <li className="pl-3 remove"><i className="fa fa-trash" aria-hidden="true" /></li>
                <li className="pl-3 bookmark"><i className="fa fa-bookmark-o" aria-hidden="true" /></li>
              </ul>
            </div>
          </div>
          <div className="row border_bottom pt-4">
        ...
        <div className="col-lg-3">
          <div className="card m-4 shadow_box">
            ...
            <div className="card-body p-2">
              <h6 className="pb-2" style={{borderBottom: '2px dashed #555'}}>Price Details</h6>
              <table className="table table-borderless card_amount">
                <tbody>
                  <tr>
                    <td><small>Subtotal of (6 items)</small></td>
                    <td><small><i className="fa fa-inr"> 8348</i></small></td>
                  </tr>
                  <tr>
                    <td><small>Delivery Fees</small></td>
                    <td><small><i className="fa fa-inr"> 50</i></small></td>
                  </tr>
                  <tr>
                    <td><small>Tax</small></td>
                    <td><small><i className="fa fa-inr"> 128</i></small></td>
                  </tr>
                  <tr>
                    <td><small>Total to be Paid</small></td>
                    <td><small><i className="fa fa-inr"> 8,398</i></small></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <button className="btn btn-default bg-warning text-white text-center proceed_pay" type="button" style={{width: '100%', borderRadius: 0, borderBottomRightRadius: '0.5rem!important', borderBottomLeftRadius: '0.5rem!important'}}>PROCEED TO PAY</button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="row">
            <div className="col-lg-2">
              <div className="new_add py-4">
                <span><img src="images/plus.png" className="img-fluid" /></span>
                <span><small><b>Add a New Address</b></small></span>
              </div>	
            </div>
            <div className="col-lg-2 d-flex align-items-center justify-content-center">	
              <button className="btn btn-default bg-warning text-white text-center address_next" type="button">NEXT</button>
            </div>
          </div>	
        </div>
      </div>
        ...
        <div className="col-lg-12">
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="card border-0">
                <div className="d-flex justify-content-between">
                  <label><small><b>HDFC Bank Debit Card</b></small></label>
                  <label><input type="radio" className="form-check-input" name="optradio" /></label>
                </div>
            ...
            <div className="col-lg-3">
              <div className="card border-0">
                <div className="d-flex justify-content-between">
                  <label><small><b>HDFC Bank Credit Card</b></small></label>
                  <label><input type="radio" className="form-check-input" name="optradio" /></label>
                </div>
                <div className="card-body db-card p-2 rounded">
                  <div className="col-lg-12">
            ...
            <div className="col-lg-2 new_add" style={{marginTop: 28}}>
              <span><img src="images/plus.png" className="img-fluid" /></span>
              <span><small><b>Add a New Card</b></small></span>
            </div>
            <div className="col-lg-2 d-flex align-items-center justify-content-center">	
              <button className="btn btn-default bg-warning text-white text-center payment_next" type="button">NEXT</button>
            </div>
          </div>	
        </div>
      </div>
        ...
        <div className="col-lg-12">
          ...
          <div className="form-check py-1">
            <label className="form-check-label">
              <input type="radio" className="form-check-input" name="payment" /><small>Net Banking</small>
            </label>
          </div>
          <div className="form-check py-1">
            <label className="form-check-label">
              <input type="radio" className="form-check-input" name="payment" /><small>EMI</small>
            </label>
          </div>
          <div className="form-check py-1">
            <label className="form-check-label">
              <input type="radio" className="form-check-input" name="payment" /><small>Cash on Delivery</small>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-lg-12">
          <div className="row border_bottom_bold pb-2">
            <span style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}><i className="fa fa-certificate cart_color" aria-hidden="true" style={{fontSize: 25}} /><i className="fa fa-check text-white" aria-hidden="true" style={{position: 'absolute', left: 4, top: 5}} /> <small className="pl-1 font_color">Thank you for shopping. Your order has been accepted. We'll notify you for further information related to your order.</small></span>
          </div>	
            ...
            <div className="col-lg-3">
              <table className="table table-borderless card_amount">
                <tbody>
                  ...
                  <tr>
                    <td><small><b>Total to be Paid</b></small></td>
                    <td><small><b><i className="fa fa-inr"> 8,398</i></b></small></td>
                  </tr>
                </tbody>
              </table>
            </div>	
          ...
          <div className="row py-3" style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
            <span><button className="btn btn-default bg-warning text-white text-center" type="button">CONTINUE</button></span>
            <span className="pl-3"><a href><small>VIEW ORDER</small></a></span>
            <span>
              <div className="form-group col-lg-12 mb-0">
                <input type="text" className="input-lg form-control" placeholder defaultValue="Share my cart to community" style={{width: 250}} />
              </div>
            </span>
          </div>
        </div>
          ...
          <div className="row border_bottom pt-4">
            ...
            <div className="col-lg-4">
              <ul className="no-bullets d-flex justify-content-end deliver_tooltip">
                <li><small>Delivered By 2-3 Days</small></li>
                <li className="pl-3 share tooltip"><i className="fa fa-share-alt" aria-hidden="true" /><span className="tooltiptext">Share this product to community</span></li>
                <li className="pl-3 remove"><i className="fa fa-trash" aria-hidden="true" /></li>
                <li className="pl-3 bookmark"><i className="fa fa-bookmark-o" aria-hidden="true" /></li>
              </ul>
            </div>
